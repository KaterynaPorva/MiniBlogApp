...
namespace MiniBlogApp.Pages
{
    ...
    public class IndexModel : PageModel
    {
         ...
         *
         * @details Uses BlogStorage to retrieve posts and session data to identify
         ...
         * @details Populated from BlogStorage when the page is loaded via OnGet method.
         */
         ...
         * @details Retrieves the username from the session and loads all posts from BlogStorage.
